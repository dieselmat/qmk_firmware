...
[_PAREN] = LAYOUT_preonic_grid( \
  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, \
  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_NO,          KC_LCBR,        KC_RCBR,        KC_NO,          KC_RABK,        KC_TRANSPARENT,  \
  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_NO,          KC_LPRN,        KC_RPRN,        KC_NO,          KC_LABK,        KC_TRANSPARENT, \
  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_NO,          KC_LBRACKET,    KC_RBRACKET,    KC_NO,          KC_NO,          KC_TRANSPARENT,  \
