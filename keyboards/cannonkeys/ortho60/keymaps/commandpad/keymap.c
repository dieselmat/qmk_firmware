...
[_MAC] = LAYOUT_ortho_5x12(
  ...
  KC_PSCR,          LGUI(KC_PSCR),  C(S(KC_UP)),    KC_NO,       KC_NO,          KC_NO,          KC_NO,              C(KC_K),        C(S(KC_K)),   C(KC_D),      C(LGUI(KC_LEFT)),  C(LGUI(KC_RIGHT)),
...
[_WIN] = LAYOUT_ortho_5x12(
  ...
  KC_PSCR,          A(KC_PSCR),     C(S(KC_UP)),    KC_NO,       KC_NO,          KC_NO,          KC_NO,              C(KC_K),        C(S(KC_K)),   C(KC_D),      C(A(KC_LEFT)),     C(A(KC_RIGHT)),
